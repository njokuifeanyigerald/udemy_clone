    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'A user with email already exists.'}, help_text='Email is required', max_length=254, unique=True, verbose_name='email address')),
                ...
                ('paid_course', models.ManyToManyField(related_name='courses', to='courses.course')),
